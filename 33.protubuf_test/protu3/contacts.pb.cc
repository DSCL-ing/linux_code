...
const uint32_t TableStruct_contacts_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::contacts::Contacts, _impl_.peopleinfo_),
};
...
const char descriptor_table_protodef_contacts_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\016\n\006number\030\001 \001(\t\"4\n\010Contacts\022(\n\npeopleinf"
  "o\030\001 \003(\0132\024.contacts.PeopleInfob\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_contacts_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_contacts_2eproto = {
    false, false, 197, descriptor_table_protodef_contacts_2eproto,
    "contacts.proto",
...
Contacts::Contacts(const Contacts& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.peopleinfo_){from._impl_.peopleinfo_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void Contacts::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.peopleinfo_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void Contacts::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.peopleinfo_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_peopleinfo(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
uint8_t* Contacts::_InternalSerialize(
  ...
  // repeated .contacts.PeopleInfo peopleinfo = 1;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_peopleinfo_size()); i < n; i++) {
    const auto& repfield = this->_internal_peopleinfo(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:contacts.Contacts)
  ...
  // repeated .contacts.PeopleInfo peopleinfo = 1;
  total_size += 1UL * this->_internal_peopleinfo_size();
  for (const auto& msg : this->_impl_.peopleinfo_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
void Contacts::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.peopleinfo_.MergeFrom(from._impl_.peopleinfo_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void Contacts::InternalSwap(Contacts* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.peopleinfo_.InternalSwap(&other->_impl_.peopleinfo_);
}
